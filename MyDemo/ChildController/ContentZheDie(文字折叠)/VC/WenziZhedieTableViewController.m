//
//  WenziZhedieTableViewController.m
//  MyDemo
//
//  Created by ShanCheli on 2017/10/19.
//  Copyright © 2017年 shancheli. All rights reserved.
//

#import "WenziZhedieTableViewController.h"
#import "TableViewCell.h"


#define LOAD_NIB(_NibName_) [[NSBundle mainBundle] loadNibNamed:_NibName_ owner:nil options:nil][0]

@interface WenziZhedieTableViewController ()
@property(nonatomic,strong) NSMutableArray *info;

@end

@implementation WenziZhedieTableViewController
