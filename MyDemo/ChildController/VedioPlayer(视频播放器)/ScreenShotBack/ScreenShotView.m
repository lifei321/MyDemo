...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [[UIApplication sharedApplication].delegate.window.rootViewController.view addObserver:self forKeyPath:@"transform" options:NSKeyValueObservingOptionNew context:szListenTabbarViewMove];
...
- (void)dealloc
{
[[UIApplication sharedApplication].delegate.window.rootViewController.view removeObserver:self forKeyPath:@"transform" context:szListenTabbarViewMove];
}
@end
